...
class LLMClassifier(nn.Module):
	...
	def __init__(self, model_path, num_labels, device_map=None, device=None, tokenizer_path=None):
		...
		self.llm = AutoModelForCausalLM.from_pretrained(model_path, torch_dtype=torch.bfloat16, device_map=self.device_map, token="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")
